					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
							<TBODY>
								<TR>
									<TD height=25>
									<FORM id="pageForm" action="${pageContext.request.contextPath }/UserAction_list" method=post>
										<!-- 隐藏域.当前页码 -->
									...
									<TD>
										<TABLE id=grid style="BORDER-TOP-WIDTH: 0px; FONT-WEIGHT: normal; BORDER-LEFT-WIDTH: 0px; BORDER-LEFT-COLOR: #cccccc; BORDER-BOTTOM-WIDTH: 0px; BORDER-BOTTOM-COLOR: #cccccc; WIDTH: 100%; BORDER-TOP-COLOR: #cccccc; FONT-STYLE: normal; BACKGROUND-COLOR: #cccccc; BORDER-RIGHT-WIDTH: 0px; TEXT-DECORATION: none; BORDER-RIGHT-COLOR: #cccccc" cellSpacing=1 cellPadding=2 rules=all border=0>
											<TBODY>
												...
												<c:forEach items="${pageBean.list }" var="usr">
												<TR style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${usr.user_name }</TD>
													<TD>${usr.user_state }</TD>
													
													<TD>
													<a href="${pageContext.request.contextPath }/UserAction_edit?user_id=${usr.user_id }">修改</a>
													&nbsp;&nbsp;
													<a id="${usr.user_id }" href="javascript:void(0);" onclick="del('${usr.user_id }')">删除</a>
													</TD>
												</TR>
												</c:forEach>
